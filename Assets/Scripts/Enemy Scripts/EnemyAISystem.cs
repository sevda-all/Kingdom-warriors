...
public class EnemyAISystem : MonoBehaviour
{
    ...
    public float distance_Attack = 6.5f;
                ...
                if (distance <= distance_MoveTo) {
                    ...
                    if(ai_State == 0) {
                        ...
                        movement_Position = transform.position  + 
                            new Vector3 (Random.Range(-patrolRange, patrolRange), 0f, Random.Range(-patrolRange, patrolRange));
                    }
                }
            }
        } else {
    ...
    void MoveToPosition(Vector3 position, float speedMult, float magnitude) {
        ...
        if (dir.magnitude > 0.1f) {
            ...
            newRotation = Quaternion.LookRotation(dir);
